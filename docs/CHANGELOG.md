...
- @fawxzzy/playbook: 0.40.0 -> 0.40.1 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.40.0 -> 0.40.1 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.40.0 -> 0.40.1 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.40.0 -> 0.40.1 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.40.0 -> 0.40.1 (playbook-installable-workspace)
...
- Pattern: Bootstrap proof should classify blockers in strict order — CLI availability first, then repository-state readiness.

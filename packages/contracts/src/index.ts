export const PLAYBOOK_SCHEMA_PATHS = {
  ...
  executionUpdatedState:
    "packages/contracts/src/execution-updated-state.schema.json",
  ...
  taskExecutionProfile:
    "packages/contracts/src/task-execution-profile.schema.json",
  ...
  improvementCandidates:
    "packages/contracts/src/improvement-candidates.schema.json",
  ...
  patternTransferPackage:
    "packages/contracts/src/pattern-transfer-package.schema.json",
  ...
  sessionEvidenceEnvelope:
    "packages/contracts/src/session-evidence-envelope.schema.json",
  ...
  docsConsolidationPlan:
    "packages/contracts/src/docs-consolidation-plan.schema.json",
} as const;

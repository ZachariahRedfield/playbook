export const PLAYBOOK_SCHEMA_PATHS = {
  ...
  memorySystem: 'packages/contracts/src/memory-system.schema.json',
  replayPromotionSystem: 'packages/contracts/src/replay-promotion-system.schema.json',
  prReview: 'packages/contracts/src/pr-review.schema.json',
  prReviewLoop: 'packages/contracts/src/pr-review-loop.schema.json',

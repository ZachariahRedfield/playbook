...
export const additiveCommandFieldSchemaRegistry: RegisteredSchemaContract[] = [
  ...
  { id: 'pattern-transfer-package', version: '1.0', path: 'packages/contracts/src/pattern-transfer-package.schema.json', kind: 'command-output' },
  ...
  { id: 'worker-results', version: '1.0', path: 'packages/contracts/src/worker-results.schema.json', kind: 'command-output' },

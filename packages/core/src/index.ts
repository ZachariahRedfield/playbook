export type { TestAutofixArtifact, TestAutofixApplySummary, TestAutofixExcludedFindingSummary, TestAutofixFinalStatus, TestAutofixHistorySummary, TestAutofixRetryPolicyDecision, TestAutofixSourceReference, TestAutofixVerificationCommandResult, TestAutofixVerificationSummary } from './contracts/testAutofix.js';
export { TEST_AUTOFIX_ARTIFACT_KIND, TEST_AUTOFIX_SCHEMA_VERSION, testAutofixFinalStatuses, testAutofixRetryPolicyDecisions } from './contracts/testAutofix.js';

...
export {
  runBootstrapProof,
  resolveBootstrapCliAvailability,
  defaultBootstrapCliResolutionCommands,
} from "./adoption/bootstrapProof.js";
export type {
  BootstrapProofStage,
  BootstrapProofFailureCategory,
  BootstrapProofCheck,
  BootstrapProofResult,
  BootstrapCliResolutionCommand,
} from "./adoption/bootstrapProof.js";
export type {
  RepoAdoptionReadiness,
  RepoAdoptionBlocker,
  ReadinessLifecycleStage,
  ReadinessConnectionStatus,
  ReadinessArtifactStatus,
  ReadinessArtifactStatusCode,
} from "./adoption/readiness.js";
export { buildFleetAdoptionReadinessSummary } from "./adoption/fleetReadiness.js";
export type {
  FleetRepoReadinessEntry,
  FleetPriorityStage,
  FleetBlockerFrequency,
  FleetRecommendedAction,
  FleetRepoPriorityEntry,
  FleetAdoptionReadinessSummary,
} from "./adoption/fleetReadiness.js";
export { buildFleetAdoptionWorkQueue } from "./adoption/workQueue.js";
export type {
  FleetAdoptionWorkQueue,
  AdoptionWorkItem,
  AdoptionWorkWave,
  AdoptionGroupedActionLane,
  AdoptionBlockedItem,
  WorkQueueAction,
...
} from "./query/patternPromotion.js";
export type {
  RepositoryQueryField,
...
export {
  extractDoctrineFromSummary,
  readDoctrineExtractionInput,
} from "./learn/doctrine.js";
export type {
  DoctrineExtractionInput,
  DoctrineExtractionResult,
  DoctrineExtractionEntry,
  DoctrineExtractionSuggestion,
  DoctrineCheckCandidate,
} from "./learn/doctrine.js";
export {
  LEARNING_COMPACTION_SCHEMA_VERSION,
  LEARNING_COMPACTION_RELATIVE_PATH,
  generateLearningCompactionArtifact,
  writeLearningCompactionArtifact,
} from "./learning/learningCompaction.js";
...
export {
  replayMemoryToCandidates,
  MEMORY_CANDIDATES_RELATIVE_PATH,
...
export type {
  ...
  MemoryReplayCandidateProvenance,
...
export type {
  LearnDraftResult,
  KnowledgeCandidate,
  KnowledgeCandidateEvidencePointer,
  KnowledgeCandidateDedupe,
} from "./schema/knowledgeCandidate.js";
export { analyzePullRequest } from "./pr/analyzePr.js";
export type { AnalyzePullRequestResult } from "./pr/analyzePr.js";
export {
  formatAnalyzePrOutput,
  formatAnalyzePrText,
  formatAnalyzePrJson,
  formatAnalyzePrGithubComment,
  formatAnalyzePrGithubReview,
} from "./formatters/analyzePrFormatter.js";
...
export type {
  ResolvedTarget,
  TargetKind,
} from "./intelligence/targetResolver.js";

export {
  explainArtifactFromArchitecture,
  explainSubsystemFromArchitecture,
...
} from "./ai/aiContract.js";

export {
  parseOrchestratorContract,
...
export {
  ...
  isCliSchemaCommand,
  CLI_SCHEMA_COMMANDS,
} from "./schema/cliSchemas.js";

export {
  buildFailureSignature,
  buildFailureSignatureSeed,
  normalizeAssertionShape,
} from "./testAutofix/failureSignature.js";
export {
  appendRemediationHistoryEntry,
  buildTriageClassifications,
  ...
  normalizeRemediationHistoryArtifact,
} from "./testAutofix/remediationHistory.js";
...
export type {
  ...
  StoryLifecycleEvent,
  StoryTransitionPreview,
  StoryReconciliationStatus,
} from "./story/stories.js";
export {
...
export type {
  WorkflowPromotion,
  WorkflowPromotionStatus,
  WorkflowPromotionValidationStatus,
} from "./schema/workflowPromotion.js";

export {
  buildExecutionOutcomeInputFromResults,
  ingestExecutionResults,
} from "./adoption/executionOutcomeIngestion.js";
export type {
  ExecutionResult,
...
export {
  materializeDeterministicEdges,
  countOrphanVertices,
} from "./graph/deterministicEdges.js";
export {
  checkVertexCompatibility,
  GROUP_BOUNDARY_FLAGS,
} from "./graph/compatibilityGuards.js";
...
export type {
  ...
  GroupBoundaryFlag,
  GraphGroup,
  GraphGroupingMetrics,
  GraphGroupArtifact,
  CandidatePatternPreview,
  CandidatePatternPreviewArtifact,
} from "./schema/graphMemory.js";
export type {
  PatternCardDraftStatus,
  PatternCardDraftRecurrence,
  PatternCardDraft,
  PatternCardDraftArtifact,
} from "./schema/patternCardDraft.js";
export type {
  PromotionReadinessBucket,
  PromotionReadiness,
...
export type {
  ...
  DecisionBatch,
  PatternCardVersionRef,
} from "./schema/promotionDecision.js";
export type {
  PatternCardDecisionType,
  PatternCardVersionEntry,
  PatternCardLineage,
  PatternTopologyDescriptor,
  PatternCard as PromotionPatternCard,
  PatternCardCollectionArtifact,
} from "./schema/patternCard.js";
...
export {
  resolveIndexedModuleContext,
  buildModuleAskContext,
} from "./query/moduleIntelligence.js";
export type {
  IndexedModuleContext,
  IndexedModuleIdentity,
  ModuleImpact,
} from "./query/moduleIntelligence.js";
...
export type {
  DocsCoverageQueryResult,
  DocsCoverageModuleResult,
  DocsCoverageSummary,
} from "./query/docsCoverage.js";

export { queryRuleOwners } from "./query/ruleOwners.js";
export type {
  RuleOwnersQueryResult,
  RuleOwnershipEntry,
} from "./query/ruleOwners.js";

export { queryModuleOwners } from "./query/moduleOwners.js";
export type {
  ModuleOwnersQueryResult,
  ModuleOwnershipEntry,
} from "./query/moduleOwners.js";
...
} from "./docs/consolidate.js";
export {
  analyzeImprovementOpportunities,
  OPPORTUNITY_ANALYSIS_RELATIVE_PATH,
  OPPORTUNITY_ANALYSIS_SCHEMA_VERSION,
} from "./improvement/opportunityAnalysis.js";
export type {
  OpportunityAnalysisArtifact,
  ImprovementOpportunity,
  OpportunityEvidencePointer,
  OpportunityHeuristicClass,
} from "./improvement/opportunityAnalysis.js";
...
export {
  ...
  buildPolicyPreflight,
} from "./policy/preflight.js";
export type {
  PolicyPreflightArtifact,
  PolicyPreflightProposal,
} from "./policy/preflight.js";
...
export {
  ...
  readLifecycleCandidatesArtifact,
  writeLifecycleCandidatesArtifact,
} from "./memory/lifecycleCandidates.js";
export {
  DOCTRINE_TRANSFORM_SCHEMA_VERSION,
  DOCTRINE_TRANSFORM_KINDS,
  assertPatternEligibleForDoctrineTransform,
  buildPatternStoryDoctrineTransform,
  generateDoctrineTransformArtifact,
} from "./doctrineTransforms.js";
export type {
  DoctrineTransformKind,
  DoctrineTransformProposal,
  DoctrineTransformArtifact,
} from "./doctrineTransforms.js";
export type {
  LifecycleCandidatesArtifact,
  LifecycleCandidateRecord,
  LifecycleEvidenceRef,
  LifecycleRecommendationAction,
...
export type {
  MemoryTimelineLookupOptions,
  MemoryCandidateLookupOptions,
  MemoryKnowledgeLookupOptions,
...
export type {
  DocsConsolidationArtifact,
  DocsConsolidationIssue,
  DocsConsolidationResult,
  WorkerFragmentArtifact,
} from "./docs/consolidate.js";
...
export {
  ...
  replayAcceptedContractProposals,
} from "./contracts/applyContractProposal.js";
export type {
  ApplyContractProposalInput,
  ApplyContractProposalResult,
  VerifyProposedContract,
} from "./contracts/applyContractProposal.js";
export {
  buildProposalArtifactPath,
  buildContractVersionArtifactPath,
...
} from "./promotion/applyPromotionDecision.js";
...
export {
  createStablePatternId,
  createPatternCard,
} from "./patternCards/createPatternCard.js";
export { materializePatternCardVersion } from "./patternCards/materializePatternCardVersion.js";
export {
  appendPatternVersion,
  markPatternSuperseded,
} from "./patternCards/versioning.js";

export {
  buildPatternTopologySignature,
  buildPatternTopologySignatures,
} from "./topology/buildPatternTopology.js";
export {
  detectPatternEquivalenceClasses,
  buildPatternEquivalenceArtifact,
  writePatternEquivalenceArtifact,
} from "./topology/detectEquivalence.js";
...
export type {
  PatternFitnessSignals,
  PatternFitnessScoreResult,
  PatternOutcomeLinks,
  RankedPatternStrength,
} from "./scoring/patternFitnessScore.js";
...
export type {
  PatternProposal,
  PatternProposalArtifact,
  PatternProposalPromotionResult,
  PatternProposalEvidence,
} from "./learning/patternProposalBridge.js";
export {
  GLOBAL_PATTERNS_RELATIVE_PATH,
  readCanonicalPatternsArtifact,
  materializeStoryFromSource,
  materializePatternFromCandidate,
  transitionPatternLifecycle,
} from "./promotion.js";
export {
  exportPatternTransferPackage,
  importPatternTransferPackage,
  PATTERN_TRANSFER_PACKAGES_RELATIVE_DIR,
} from "./patternTransfer.js";
export type {
  PromotionSourceRef,
  StoryRecordWithProvenance,
  StoryPromotionProvenance as PromotionStoryProvenance,
  PromotedPatternRecord,
  CanonicalPatternsArtifact,
  PreparedPromotion,
} from "./promotion.js";
export type {
  PatternTopologySignature,
  PatternEquivalenceClass,
  PatternVariant,
  PatternTopologyTelemetry,
  PatternEquivalenceArtifact,
} from "./schema/patternTopology.js";
...
export type {
  AnalyzePlaybookArtifactsInput,
  AnalyzePlaybookArtifactsResult,
} from "./meta/analyzePlaybookArtifacts.js";
export type {
  MetaFindingType,
  MetaFinding,
  MetaFindingsArtifact,
} from "./schema/metaFinding.js";
export type {
  MetaProposal,
  MetaProposalsArtifact,
} from "./schema/metaProposal.js";
...
export {
  writeJsonArtifact as writeArtifactJson,
  readJsonArtifact as readArtifactJson,
  INVALID_ARTIFACT_ERROR,
} from "./artifacts/artifactIO.js";
...
export type {
  ...
  ExecutionPlanSourceArtifacts,
} from "./routing/executionPlan.js";
...
export type {
  AgentRunPlanDryRunInput,
  AgentRunPlanDryRunResult,
} from "./runtime/index.js";

export {
  createExecutionRun,
  createExecutionIntent,
} from "./execution/createExecutionRun.js";
export {
  startExecution,
  updateLaneState,
  recordWorkerResult,
...
} from "./execution/updateExecutionRun.js";
export {
  writeExecutionRun,
  readExecutionRun,
  listExecutionRuns,
  getLatestMutableRun,
  executionRunPath,
} from "./execution/writeExecutionRun.js";
...
} from "./execution/runContract.js";

export {
  buildOrchestratorContract,
  writeOrchestratorArtifact,
  compileOrchestratorArtifacts,

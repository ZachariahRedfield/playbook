    ...
    properties: {
      ...
      controlPlaneArtifacts: {
        ...
        properties: {
          ...
          improvementCandidates: {
            const: ".playbook/improvement-candidates.json",
          },
            ...
            properties: {
              artifactLocations: {
                ...
                properties: {
                  ...
                  policyEvaluation: {
                    const: ".playbook/policy-evaluation.json",
                  },
                  policyApplyResult: {
                    const: ".playbook/policy-apply-result.json",
                  },
                  promotedKnowledge: {
                    type: "array",
                    prefixItems: [
    ...
    properties: {
      ...
      findings: {
        ...
        items: {
          ...
          properties: {
            category: {
              enum: ["Architecture", "Docs", "Testing", "Risk", "Memory"],
            },
        ...
        properties: {
          ...
          artifact: {
            ...
            properties: {
              ...
              artifactPath: { const: ".playbook/docs-consolidation-plan.json" },
              sourceArtifactPath: {
                const: ".playbook/docs-consolidation.json",
              },
              mutationBoundary: { const: "apply-only" },
              tasks: {
                type: "array",
                items: {
                  type: "object",
                  additionalProperties: true,
                  required: ["id", "ruleId", "file", "action", "autoFix"],
                },
              },
              summary: {
                type: "object",
                ...
                properties: {
                  candidateGroupCount: { type: "integer" },
                  executableTaskCount: { type: "integer" },
                  exclusionCount: { type: "integer" },
                },
              },
              approvedGroups: {
                type: "array",
            ...
            items: {
              ...
              properties: {
                ...
                expected_scan_impact: {
                  ...
                  additionalProperties: false,
                  required: [
                    "estimated_files_reduced",
                    "estimated_bytes_reduced",
                    "impact_level",
                  ],
                  properties: {
                ...
                safety_level: {
                  enum: ["safe-default", "likely-safe", "review-first"],
                },
        ...
        properties: {
          ...
          suggestedNotesUpdate: {
            ...
            items: {
              ...
              properties: {
                target: {
                  enum: ["notes", "patterns-docs", "changelog", "verification"],
                },
                summary: { type: "string" },
                rationale: { type: "string" },
              },
      ...
      },
      {
        ...
        properties: {
          ...
          source: {
            type: "object",
            additionalProperties: false,
            required: ["latest_result_path", "remediation_history_path"],
            properties: {
              latest_result_path: { type: "string" },
          ...
          telemetry: {
            ...
            required: [
              "confidence_buckets",
              "failure_classes",
              "blocked_low_confidence_runs",
              "top_repeated_blocked_signatures",
              "dry_run_runs",
              "apply_runs",
              "dry_run_to_apply_ratio",
    ...
    oneOf: [
      ...
      },
      {
        ...
        required: [
          ...
          "applied_task_ids",
          "excluded_finding_summary",
          "final_status",
          "reason",
          "failure_signatures",
          "history_summary",
          "preferred_repair_class",
          "autofix_confidence",
        ...
        properties: {
          ...
          history_summary: {
            ...
            required: [
              "matched_signatures",
              "matching_run_ids",
              "prior_final_statuses",
              "prior_applied_repair_classes",
              "prior_successful_repair_classes",
              "repeated_failed_repair_attempts",
              "provenance_run_ids",
            ],
            properties: {
              matched_signatures: { type: "array", items: { type: "string" } },
              matching_run_ids: { type: "array", items: { type: "string" } },
              prior_final_statuses: {
                type: "array",
                items: { type: "string" },
              },
              ...
              provenance_run_ids: { type: "array", items: { type: "string" } },
            },
          },
          ...
          verification_result: {
            type: "object",
            additionalProperties: false,
            required: ["attempted", "ok", "total", "passed", "failed"],
            properties: {
              attempted: { type: "boolean" },
              ok: { type: "boolean" },
              total: { type: "integer" },
          ...
          excluded_finding_summary: {
            type: "object",
            additionalProperties: false,
            required: ["total", "review_required", "by_reason"],
            properties: {
              total: { type: "integer" },
          ...
          findings: {
            ...
            items: {
              ...
              properties: {
                ...
                repair_class: {
                  enum: ["autofix_plan_only", "review_required"],
                },
                summary: { type: "string" },
...
export const CLI_SCHEMA_COMMANDS: readonly CliSchemaCommand[] = Object.freeze(
  Object.keys(cliSchemas) as CliSchemaCommand[],
);
...
export const getCliSchema = (command: CliSchemaCommand): JsonSchema =>
  cliSchemas[command];

...
export const commandMetadata: CommandMetadata[] = [
  ...
  {
    name: 'telemetry',
    description: 'Inspect deterministic repository/process telemetry and compact cross-run learning summaries',
    category: 'Utility',
    role: 'utility',
    lifecycle: 'utility',
    discoverability: 'secondary',
  ...
  {
    name: 'policy',
    description: 'Evaluate improvement proposals against governed runtime evidence (read-only control-plane)',
    category: 'Utility',
    role: 'governance',
    lifecycle: 'canonical',
    discoverability: 'secondary',

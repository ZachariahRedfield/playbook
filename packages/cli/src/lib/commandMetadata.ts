...
export const commandMetadata: CommandMetadata[] = [
  ...
  },
  {
    name: "workers",
    description:
      "Assign deterministic proposal-only workers to ready lanes from .playbook/lane-state.json",
    category: "Core",
    role: "remediation",
    lifecycle: "canonical",
    discoverability: "primary",
  ...
  {
    name: "test-fix-plan",
    description: "Build deterministic test-only fix planning from a test-triage artifact",
    category: "Repository tools",
    role: "remediation",
    lifecycle: "canonical",
    discoverability: "secondary",

...
- `workers`: Assign deterministic proposal-only workers to ready lanes from .playbook/lane-state.json
...
- `test-fix-plan`: Build deterministic test-only fix planning from a test-triage artifact
